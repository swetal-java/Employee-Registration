	...
	<div class="container">
		<div class="row mx-0 justify-content-center">
			<div class="col-md-7 col-lg-5 px-lg-2 col-xl-4 px-xl-0 px-xxl-3">
				...
				<label class="d-block mb-4"><span
						class="form-label d-block"></span>Gender: <input
					...
					<label class="d-block mb-4"> <span
						class="form-label d-block"></span> <input name="empid"
						type="text" class="form-control" 
						placeholder="Employe ID" required />
					</label>
					
					<label class="d-block mb-4"> <span
						class="form-label d-block"></span> <input name="empname"
						type="text" class="form-control" 
						placeholder="Employe Name" required />
					</label>
					
					<label class="d-block mb-4"> <span
						class="form-label d-block"></span> <input name="desg"
						type="text" class="form-control" 
						placeholder="Employe Designation" required />
					</label>
